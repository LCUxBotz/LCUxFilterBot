...
async def cb_handler(client: Client, query: CallbackQuery):
            ...
            try:
                for file in files:
                    ...
                    if result.deleted_count:
                        logger.info(f'File Found for your query {keyword}! Successfully deleted {caption} from database.')
                    deleted += 1
                    if deleted % 50 == 0:
    ...
    # don't change anything without contacting me @kingvj01
        ...
        btn = [[
            InlineKeyboardButton("👇 Sᴇʟᴇᴄᴛ Yᴏᴜʀ Lᴀɴɢᴜᴀɢᴇs 👇", callback_data="laninfo")
        ],[
